...
namespace Rendering
{
    ...
    Triangle::Triangle(Game& game, Camera& camera)
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
		...
		BasicEffectVertex vertices[] =
		{
					...
					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(-0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),

					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),

					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(-1.2f, 2.2f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(-0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),

					BasicEffectVertex(XMFLOAT4(-1.2f, 2.2f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(-1.25f, 1.6f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(-1.8f, 1.5f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),


					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(1.8f, 2.6f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),


					BasicEffectVertex(XMFLOAT4(-1.5, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
					BasicEffectVertex(XMFLOAT4(0.0f, 2.5f, 2.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),
